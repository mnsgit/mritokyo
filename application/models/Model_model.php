...
class Model_model extends CI_Model{
	...
	function get_all($id = ''){
        ...
        $this->db->select("$this->tbl.*, $this->tbl_type.name as bodytype_name, $this->tbl_maker.name as maker_name, $this->tbl_brand.name as brand_name");
        ...
        $this->db->join($this->tbl_brand,$this->tbl_brand.'.id = '.$this->tbl.'.brand_id', 'left', true);
        if($id){
